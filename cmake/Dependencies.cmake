...
if(asio_ADDED)
  ...
  if(TARGET libgossip_core)
    ...
    if(MSVC)
      # MSVC: Disable deprecated function warnings
      target_compile_options(libgossip_core PRIVATE /wd4996)
    else()
      # GCC/Clang: Disable deprecated declarations warnings
  ...
  elseif(TARGET libgossip::core)
    ...
    if(actual_target AND TARGET ${actual_target})
      ...
      if(MSVC)
        # MSVC: Disable deprecated function warnings
        target_compile_options(${actual_target} PRIVATE /wd4996)
      else()
        # GCC/Clang: Disable deprecated declarations warnings
