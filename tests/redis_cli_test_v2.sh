...
skip_test "GETBIT (implementation differs)"
test_command "GETBIT" "GETBIT bitmap_key 1" "0"
skip_test "SETBIT (implementation differs)"
test_command "GETBIT" "GETBIT bitmap_key 0" "0"
