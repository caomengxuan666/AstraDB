...
// PFCOUNT key [key ...] - Returns the approximated cardinality of the set(s) observed by the HyperLogLog
CommandResult HandlePfCount(const protocol::Command& command, CommandContext* context);

// PFMERGE destkey sourcekey [sourcekey ...] - Merges multiple HyperLogLog values into a single value
