...
// Key type enumeration (duplicated from storage::KeyType to avoid circular
// dependency)
...
inline uint8_t KeyTypeToRdbType(astra::KeyType key_type) {
  switch (key_type) {
    case astra::KeyType::kString:
      return RDB_TYPE_STRING;
    case astra::KeyType::kHash:
      return RDB_TYPE_HASH;
    case astra::KeyType::kList:
      return RDB_TYPE_LIST;
    case astra::KeyType::kSet:
      return RDB_TYPE_SET;
    case astra::KeyType::kZSet:
      return RDB_TYPE_ZSET;
    case astra::KeyType::kStream:
      return RDB_TYPE_HASH;  // Stream not supported, use hash
    default:
...
inline uint8_t KeyTypeToRdbType(astra::storage::KeyType key_type) {
  ...
  switch (val) {
    case 1:
      return RDB_TYPE_STRING;  // kString
    case 2:
      return RDB_TYPE_HASH;  // kHash
    case 5:
      return RDB_TYPE_LIST;  // kList
    case 3:
      return RDB_TYPE_SET;  // kSet
    case 4:
      return RDB_TYPE_ZSET;  // kZSet
    case 6:
      return RDB_TYPE_HASH;  // kStream -> HASH
    default:
      return RDB_TYPE_STRING;  // Default to string
  }
}
...
inline astra::KeyType RdbTypeToKeyType(uint8_t rdb_type) {
  switch (rdb_type) {
    case RDB_TYPE_STRING:
      return astra::KeyType::kString;
    case RDB_TYPE_HASH:
      return astra::KeyType::kHash;
    case RDB_TYPE_LIST:
      return astra::KeyType::kList;
    case RDB_TYPE_SET:
      return astra::KeyType::kSet;
    case RDB_TYPE_ZSET:
      return astra::KeyType::kZSet;
    default:
      return astra::KeyType::kString;  // Default to string
  }
}
